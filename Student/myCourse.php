          ...
          <div class="row">
              ...
              <div class="col-sm-6 mb-3">
                <div class="card-body">
                  ...
                  <p class="card-text d-inline">Price: <small><del>LKR <?php echo $row['course_original_price'] ?> </del></small> <span class="font-weight-bolder">LKR <?php echo $row['course_price']?> <span></p>
