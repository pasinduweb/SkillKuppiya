...
?>  
   <div class="container">
     ...
     <div class="form-group row">
        ...
        <div>
          <input class="btn btn-secondary mx-4" value="View" type="submit"	onclick="">
        </div>
      </div>
     </form>
    </div>
              ...
              <div class="col-auto">
                ...
                <table class="table table-bordered">
                  <tbody>
                      ...
                      <tr>
                        <td></td>
                          <td><button class="btn btn-secondary" onclick="javascript:window.print();">Print Receipt</button></td>
                      </tr>
                    </tbody>
                  </table>      
                </div>
